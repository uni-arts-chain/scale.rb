    ...
    class Metadata
      ...
      def self.decode(scale_bytes)
        ...
        if bytes.bytes_to_utf8 == "meta"
          version_enum = {
            "type" => "enum",
            "value_list" => %w[MetadataV0 MetadataV1 MetadataV2 MetadataV3 MetadataV4 MetadataV5 MetadataV6 MetadataV7 MetadataV8 MetadataV9 MetadataV10 MetadataV11 MetadataV12 MetadataV13 MetadataV14]
          }
